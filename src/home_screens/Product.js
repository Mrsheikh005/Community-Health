...
const Product = () => {
	...
	return (
		...
		<SafeAreaView style={{ flex: 1, justifyContent: 'space-between',backgroundColor:Colors.white,paddingBottom:'5%'}}>
				<TransparentHeader title="Shop Medical Products" />
                <Image style={{ width: '100%',height:'40%' }} resizeMode='cover' source={{uri:'https://communityhealth.ae/public/' + Data.thumbnail_image} }/>
				<View style={{paddingHorizontal:'5%'}} >
                    ...
                    <StarRating
                        ...
                        <TouchableOpacity style={{height:35,width:35,alignItems:'center',justifyContent:'center',elevation:5,backgroundColor:Colors.white,borderRadius:10}} onPress={()=>{
                            setQuantity(Quantity-1)
                        }}>
                        <Feather name="minus" size={20} color={Colors.black}/>
                        </TouchableOpacity>
                        <Text style={{color:Colors.black, fontSize:18, fontWeight:'700',marginHorizontal:15,alignSelf:'center'}}>
                           {Quantity} 
                        </Text>
                        <TouchableOpacity style={{height:35,width:35,alignItems:'center',justifyContent:'center',elevation:5,backgroundColor:Colors.white,borderRadius:10}} onPress={()=>{
                            setQuantity(Quantity+1)
